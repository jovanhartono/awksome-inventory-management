    ...
    <Transition appear show={isOpen} as={Fragment}>
      <HeadlessDialog as="div" className="relative z-10" onClose={closeDialog}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <HeadlessDialog.Backdrop className="fixed inset-0 bg-black bg-opacity-25" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <HeadlessDialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-white text-left align-middle shadow-xl transition-all">
                <HeadlessDialog.Title
                  as="div"
                  className="flex justify-between items-center px-5 py-4 shadow"
                >
